#!/usr/bin/env python3
"""
sms04_probe.py · SMS-04 · the intranet binding ceremony, walked
=================================================================
...
LEGACY_A = "+13035059612"                       # a pre-SMS-04 buzz binding
...
def main():
    ...
    print(f"sms04-probe: {COUNT} probes, {len(FAILURES)} failure(s)")
